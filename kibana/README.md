...
运行web-app文件夹中的stress_test.py。产生访问日志数据

### 仪表盘主界面

直接点击以下链接访问监控中心：
👉 **[Web应用监控仪表盘](http://localhost:5601/app/dashboards#/list?_g=(filters:!(),refreshInterval:(pause:!t,value:60000),time:(from:now-15d,to:now))&sort=title&sortdir=desc)**
...
4. **备份策略**：
   ...
   - 定期通过Kibana"Stack Management > Saved Objects"导出仪表盘配置
   - 重要仪表盘配置建议保存版本记录
...
**最后更新**：2025年12月**版本**：1.0.0**维护者**：云计算课程项目组

> 这个仪表盘是实时监控系统的"眼睛"，通过它不仅能发现问题，更能理解用户行为、优化应用性能。Happy Monitoring! 📈
>
